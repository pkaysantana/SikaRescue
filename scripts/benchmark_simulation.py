...
try:
    ...
    from sikarescue.compute.scenarios import SCENARIOS, simulation_config
...
def main() -> None:
    ...
    parser.add_argument("--scenarios", type=int, default=len(SCENARIOS), choices=range(1, 7))
    ...
    scenarios = list(SCENARIOS.values())[: args.scenarios]
    ...
    print()
    print(
        f"end-to-end LocalRouteComputeBackend (default config, {len(candidates)} candidates): "
